...
vgit.setup({
    ...
    keymaps = {
        ...
        ['n <Down>'] = 'hunk_down',
        ['n <leader>vg'] = 'actions',
        ['n <leader>vgs'] = 'buffer_hunk_stage',
        ['n <leader>vgr'] = 'buffer_hunk_reset',
        ['n <leader>vgp'] = 'buffer_hunk_preview',
        ['n <leader>vgb'] = 'buffer_blame_preview',
        ['n <leader>vgf'] = 'buffer_diff_preview',
        ['n <leader>vgh'] = 'buffer_history_preview',
        ['n <leader>vgu'] = 'buffer_reset',
        ['n <leader>vgg'] = 'buffer_gutter_blame_preview',
        ['n <leader>vgd'] = 'project_diff_preview',
        ['n <leader>vgq'] = 'project',
        ['n <leader>vgx'] = 'toggle_diff_preference',
    },
    controller = {
        hunks_enabled = true,
        blames_enabled = true,
