if !has('gui_running') && &t_Co < 256
  ...
  if exists('syntax_on')
    ...
    let g:colors_name = 'isjaki'


    hi! StatusLineFilename guifg=#e2a478 guibg=#111111 ctermfg=109 ctermbg=233
    ...
    hi! StatusLineInactive ctermfg=239 ctermbg=235 guifg=#444b71 guibg=#1e2132
    ...
    hi! InformationMsg ctermbg=234 ctermfg=203 guibg=#161821 guifg=#e2db78
    hi! HintMsg ctermbg=234 ctermfg=203 guibg=#161821 guifg=#a1e278
    ...
    hi! TabLineSel ctermfg=150 gui=bold guifg=#e2a478
    hi! Title ctermfg=216 gui=NONE guifg=#e2a478
    hi! Todo ctermbg=234 ctermfg=150 guibg=#89b8c2 guifg=#45493e
